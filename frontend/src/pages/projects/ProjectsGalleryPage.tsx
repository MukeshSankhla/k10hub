...
/**
 * Reusable Card matching original design with 4:3 cover, diagonal ribbon, and clickable author
 */
        ...
        >
          ...
          <div
            style={{
              ...
              backgroundColor:
                project.type?.toLowerCase() === 'tutorial' ? '#EAB308' : '#F59E0B',
              color:
                project.type?.toLowerCase() === 'tutorial' ? '#ffffff' : '#000000',
              fontSize: '10px',
              fontWeight: 800,
